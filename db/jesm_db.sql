...
-- Dumping data for table jesm_db.tbl_job_order: ~10 rows (approximately)
...
INSERT INTO `tbl_job_order` (`jo_id`, `reference_number`, `customer_id`, `service_id`, `service_fee`, `remarks`, `user_id`, `jo_date`, `status`, `date_added`, `date_last_modified`) VALUES
	...
	(11, 'JO-20221031032227', 22, 3, 0.00, '', 0, '2022-10-31', '', '2022-10-31 10:22:34', '2022-10-31 10:22:34'),
	(12, 'JO-20221031032255', 22, 3, 0.00, '', 0, '2022-10-31', '', '2022-10-31 10:23:05', '2022-10-31 10:23:05'),
	(13, 'JO-20221031073644', 22, 6, 2500.00, '', 0, '2022-10-31', '', '2022-10-31 14:37:41', '2022-10-31 15:00:28');
...
-- Dumping data for table jesm_db.tbl_job_order_details: ~16 rows (approximately)
...
-- Dumping data for table jesm_db.tbl_logs: ~11 rows (approximately)
...
-- Dumping data for table jesm_db.tbl_purchase_order: ~6 rows (approximately)
...
-- Dumping data for table jesm_db.tbl_purchase_order_details: ~13 rows (approximately)
...
-- Dumping data for table jesm_db.tbl_users: ~2 rows (approximately)
...
INSERT INTO `tbl_users` (`user_id`, `user_fullname`, `user_category`, `username`, `password`, `date_added`, `date_last_modified`) VALUES
	...
	(3, 'Staff', 'S', 'staff', 'b148e7f41fdc3be4b14e8d17e068bbad', '2022-10-31 15:21:57', '2022-10-31 15:21:57');
...
-- Dumping data for table jesm_db.tbl_user_privileges: ~4 rows (approximately)
...
INSERT INTO `tbl_user_privileges` (`privilege_id`, `user_id`, `url`, `status`, `date_added`, `date_last_modified`) VALUES
	...
	(10, 3, 'suppliers', 1, '2022-10-31 16:46:55', '0000-00-00 00:00:00'),
	(11, 3, 'products', 1, '2022-10-31 16:46:55', '0000-00-00 00:00:00'),
	(12, 3, 'services', 1, '2022-10-31 16:46:55', '0000-00-00 00:00:00');
